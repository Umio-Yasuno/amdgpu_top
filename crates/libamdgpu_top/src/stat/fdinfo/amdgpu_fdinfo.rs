    ...
    pub fn get_proc_usage(&mut self, proc_info: &ProcInfo) {
        ...
        let diff = if let Some(pre_stat) = self.pid_map.get_mut(&pid) {
            ...
            *pre_stat = stat;
            ...
            FdInfoUsage {
                vram_usage: stat.vram_usage,
                gtt_usage: stat.gtt_usage,
                system_cpu_memory_usage: stat.system_cpu_memory_usage,
                amd_visible_vram: stat.amd_visible_vram,
                amd_evicted_vram: stat.amd_evicted_vram,
                amd_evicted_visible_vram: stat.amd_evicted_visible_vram,
                amd_requested_vram: stat.amd_requested_vram,
                amd_requested_visible_vram: stat.amd_requested_visible_vram,
                amd_requested_gtt: stat.amd_requested_gtt,
                ..Default::default()
            }
        };
